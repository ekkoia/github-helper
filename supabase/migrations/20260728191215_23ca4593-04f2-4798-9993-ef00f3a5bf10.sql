...
BEGIN
  ...
  -- Regra Meta:
  -- DDD 11-28: força o 9 na frente do assinante, independentemente do primeiro dígito (celulares e antigos fixos com 8 dígitos).
  -- Demais DDDs: mantém 12 dígitos (sem 9).
