...
-- O created_time JÁ está no horário Brasil, então só convertemos o texto para timestamp
UPDATE leads l
...
-- Atualizar trigger para novos leads - SEM conversão AT TIME ZONE
...
BEGIN
  ...
  -- O created_time JÁ está no horário Brasil
