...
BEGIN
  ...
  -- Regra especial: telefone dedicado ao Davi Lopes
  v_phone_key := public.phone_key(NEW.telefone);
  IF v_phone_key = public.phone_key('5565999194001') THEN
    NEW.responsavel_id := '53c0f848-84da-48c7-8cde-66076dbeb071'::uuid;
    RETURN NEW;
  END IF;
