  ...
  try {
    ...
    const emailHtml = `
      ...
      <head>
        ...
        <title>Recuperação de Senha - CRM Arvora</title>
        <style>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              <h2 style="font-family: 'Saira', 'Poppins', 'Segoe UI', Arial, sans-serif; color: #0A3642; margin: 0 0 20px 0; font-size: 24px; font-weight: 600;">Recuperação de Senha</h2>
              <p style="color: #3C4749; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                Recebemos uma solicitação para redefinir a senha da sua conta no <strong>CRM Arvora</strong>.
                Clique no botão abaixo para criar uma nova senha.
              </p>
              
              <div style="background-color: #EDF5F7; border: 1px solid #6E7E82; border-radius: 8px; padding: 16px; margin: 20px 0;">
                <p style="color: #3C4749; font-size: 12px; margin: 0 0 4px 0; text-transform: uppercase; letter-spacing: 0.5px;">Sua conta</p>
              ...
              <p style="color: #6E7E82; font-size: 13px; line-height: 1.6; margin: 20px 0 0 0;">
    ...
    const response = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: [to_email],
        subject: "Redefinição de Senha - CRM Arvora",
        html: emailHtml,
      }),
    });
